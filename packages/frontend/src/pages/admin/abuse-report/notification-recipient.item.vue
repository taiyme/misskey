...
const emit = defineEmits<{
	(ev: 'edit', id: Misskey.entities.AbuseReportNotificationRecipient['id']): void;
	(ev: 'delete', id: Misskey.entities.AbuseReportNotificationRecipient['id']): void;
}>();

const props = defineProps<{
	entity: Misskey.entities.AbuseReportNotificationRecipient;
}>();
