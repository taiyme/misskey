...
const imageUrl = computed(() => {
	if (props.type === 'info') return customImage.infoImageURL;
	if (props.type === 'notfound') return customImage.notFoundImageURL;
	if (props.type === 'error') return customImage.errorImageURL;
	return null;
});
</script>
